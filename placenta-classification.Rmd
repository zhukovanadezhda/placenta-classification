...
# quantiles <- quantile(variances, c(0.23, 0.25, 0.5, 0.75))
# quantiles_ecarts <- quantile(ecarts, c(0.23, 0.25, 0.5, 0.75))
# quantiles
# quantiles_ecarts
# quantiles[1]
# quantiles_ecarts[1]

# Nouveau dtf sans les descripteurs à variances nulles
# ind_var_0 <- which(variances == 0)
# my_dtf_ss_var_0 <- my_dtf_initial[,-ind_var_0]
...
# normalisation
my_dtf2_scaled <- scale(my_dtf2, center = TRUE, scale = TRUE)
my_dtf3_scaled <- scale(my_dtf3, center = TRUE, scale = TRUE)
dim(my_dtf2_scaled)
dim(my_dtf3_scaled)
...
# couples
ind_hab2 <- which(colnames(my_dtf2_scaled) == "CI2")
ind_hab3 <- which(colnames(my_dtf3_scaled) == "CI3")
plot(res_PCA2, habillage = ind_hab2, cex = 0)
plot(res_PCA3, habillage = ind_hab3, cex = 0)
```
